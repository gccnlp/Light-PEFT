...
class NLUDataset():
    def __init__(self, tokenizer: AutoTokenizer, data_args, training_args) -> None:
        super().__init__()
        raw_datasets = load_dataset(data_args.task_name, data_args.dataset_name)
        ...
        self.metric = load_metric(data_args.task_name, data_args.dataset_name)
    ...
    def reocrd_compute_metrics(self, p: EvalPrediction):
        from nlu_utils import f1_score, exact_match_score, metric_max_over_ground_truths
