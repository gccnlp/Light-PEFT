...
from .peft_model import (
    ...
    PeftModelForMultipleChoice
)
from .tuners import LoraConfig, PrefixTuningConfig, PromptEncoderConfig, PromptTuningConfig, BottleneckConfig, AdaLoraConfig
...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING = {
    ...
    "MULTI_CHOICE": PeftModelForMultipleChoice,
}
...
def get_peft_model(model, peft_config):
    ...
    if not isinstance(peft_config, PromptLearningConfig):
        if peft_config.peft_type == "BOTTLENECK":
            ...
            peft_config = _prepare_lora_config(peft_config, model_config)
        elif peft_config.peft_type == "ADALORA":
            pass
    else:
